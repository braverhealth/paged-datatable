                            ...
                            .map(
                              (e) => Padding(
                                ...
                                child: Chip(
                                  ...
                                  label: Text(
                                    (e._filter as dynamic).chipFormatter(
                                      e.value,
                                    ),
                                  ),
                                ),
  ...
  Widget build(BuildContext context) {
            ...
            ...tableController._filtersState.entries
                ...
                .map(
                  (entry) => Padding(
                    ...
                    child: entry.value._filter.buildPicker(
                      context,
                      entry.value,
                    ),
                  ),
    ...
    Widget child = Material(
      shape: RoundedRectangleBorder(
        borderRadius: theme.filterDialogBorderRadius,
      ),
      elevation: 0,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white,
                boxShadow: theme.filterDialogBoxShadow,
                borderRadius: theme.filterDialogBorderRadius,
              ),
              child: child,
            ),
